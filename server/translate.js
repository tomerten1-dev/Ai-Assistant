...
Rules: do not add, drop or soften anything. Keep every number, age, date, price range and phone number exactly as written (the office number may be written in international form, +972-4-…). Keep hotel and resort names exactly as written (Latin names unchanged; Hebrew resort names transliterated the usual way, e.g. בנסקו → Bansko, מאיירהופן → Mayrhofen, לה דו אלפ → Les 2 Alpes). The company is "Pingwin" (פינגווין) — never translate it as a bird. "עברית" is the Hebrew language: the kids' club runs in Hebrew, and that stays "Hebrew" in every language — never the customer's own language. A refusal stays a refusal; "a rep will confirm" stays. One question at the end stays one question. No emoji, no bullet points, no headings.
